...
<body>
	...
	<div id="sidedrawer" class="mui--no-user-select">
		...
		<ul>
			...
			<li><strong><a href="pay.jsp">充值</a> </strong></li>
			<li><strong><a href="pay.jsp">设置</a> </strong></li>
		</ul>
	</div>
	<header id="header">
		...
		<div class="mui-container-fluid">
			<s:iterator value="result">
				<div class="mui-panel" style="margin-top:20px">
					...
					<br> <br> &nbsp<a
						class="mui--text-accent mui--text-body1"><s:property
							value="username" /> </a>· 悬赏：<span
						class="mui--text-accent mui--text-body1"><s:property
							value="score" /> </span> <span style="float:right;"
						class="mui--text-accent mui--text-body1"> <s:property
